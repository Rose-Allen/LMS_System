...
public class LessonServiceImpl implements LessonService {
    ...
    public LessonDto updateLesson(LessonDto lessonDto) {
        ...
        try {
            foundLesson.setName(lessonDto.getLessonName());
            foundLesson.setContent(lessonDto.getLessonContent());
            foundLesson.setDescription(lessonDto.getLessonDescription());
            foundLesson.setUpdateTime(LocalDateTime.now());

            Lesson savedLesson = lessonRepository.save(foundLesson);

            log.info("Урок по названию: {} - была обновлена", savedLesson.getName());
